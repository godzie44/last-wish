...
func (u *User) __d3_makeFieldExtractor() entity.FieldExtractor {
	return func(s interface{}, name string) (interface{}, error) {
		...
		case "wishes":
			return sTyped.wishes, nil

		case "friends":
			return sTyped.friends, nil
...
func (u *User) __d3_makeCopier() entity.Copier {
	return func(src interface{}) interface{} {
		...
		if srcTyped.wishes != nil {
			copy.wishes = srcTyped.wishes.DeepCopy().(*entity.Collection)
		}
		if srcTyped.friends != nil {
			copy.friends = srcTyped.friends.DeepCopy().(*entity.Collection)
		}
...
func (u *User) __d3_makeComparator() entity.FieldComparator {
	return func(e1, e2 interface{}, fName string) bool {
		...
		case "wishes":
			return e1Typed.wishes == e2Typed.wishes
		case "friends":
			return e1Typed.friends == e2Typed.friends
		default:
			return false
		}
	}
